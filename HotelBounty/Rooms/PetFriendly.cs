...
public class PetFriendly : Room
{
    ...
    public PetFriendly(int roomNumber, Hotel hotel, Occupancy occupancy, double price, bool climatization, bool isCleaned, bool isAvailable, string petFeeders, int maxPetsAllowed)
